...
public class Board {
	 ...
	 *
	 * @param board
	 *            board state for which a winner will be determined.
	 *
	 ...
	 *
	 * @param piece
	 *            the piece that is making a move.
	 * @param position
	 *            the position to which a player is making a move.
	 * @param list
	 *            list of coordinates that should be flipped from the opponent's
