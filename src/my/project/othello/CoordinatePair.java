...
public class CoordinatePair{
	...
	/**
	*
	* Constructor for a CoordinatePair object that represents coordinates on the board
	*
	...
	*/
	...
	/**
	*
	* Returns a string representation of the coordinate on the board where the row and column are combined together
	*
	* @return string representation of the coordinate on the board where the row and column are combined together
	*/
	...
	/**
	*
	* Returns the row value encoded in a string where the row and column are combined together
	*
	* @param position string representation of a coordinate on the board where the row and column are combined together
	*
	...
	*/
	...
	/**
         *
 	 * Returns the column value encoded in a string where the row and column are combined together
	 *
	 * @param position string representation of a coordinate on the board where the row and column are combined together
	 *
